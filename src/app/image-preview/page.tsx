        ...
        <div className="px-4 py-6">
          ...
          <div className="flex items-center justify-center">
            <div className="w-full">
              <button className="w-full text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center justify-center mr-2 mb-2 cursor-pointer" onClick={() => console.log("Upload")}>
